...
<div class="container-xl">
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            $view_users_query="SELECT * FROM `fees` where email='$email'";//select query for viewing users.  
            ...
            <tr>
                ...
                <td><a href="paid.php?id=<?php echo $row['id'];?>" class="btn btn-success text-white">Click to Paid</a></td>
            </tr>
       <?php }?> 
