...
<div class="container-xl">
  ...
  <?php  
        include("connect.php");  
        $view_users_query="select * from attendancetable where batch='plus 1' ";//select query for viewing users.  
...
<!--here showing results in the table -->  
  ...
  <?php  
        include("connect.php");  
        $view_users_query="select * from attendancetable where batch='plus 2' ";//select query for viewing users.  
        $run=mysqli_query($conn,$view_users_query);//here run the sql query.  
