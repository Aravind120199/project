...
<?php  
include("connect.php");  
$view_users_query="SELECT * from subject  WHERE batch='plus one'";//select query for viewing users.  
...
<?php  
include("connect.php");  
$view_users_query="SELECT * from subject WHERE batch='Plus two' ";//select query for viewing users.  
$run=mysqli_query($conn,$view_users_query);//here run the sql query.  
