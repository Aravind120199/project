                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="Name" type="text" readonly="readonly" value="<?php  echo $name;?>">
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="Lastname" type="text" readonly="readonly"  value=<?php  echo $l_name;?>>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="phone" type="num"  readonly="readonly"  value=<?php  echo $p;?>>
                        </div>
                        <!-- Form Row-->
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="Email_id"  type="email"  readonly="readonly"  value=<?php  echo $var;?>>
                            </div>
