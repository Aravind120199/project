            ...
            <div class="row">
              ...
              <div class="card mb-4">
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <?php
                      $query = "SELECT tblstudents.Id,tblstudents.firstName,
                      tblstudents.lastName,tblclass.className AS classArmId,tblstudents.firstName,
                      tblstudents.lastName,tblclass.className
                      FROM tblstudents
