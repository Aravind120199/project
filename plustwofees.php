...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        <li>
          <a href="office.php" class="active">
...
$view_users_query="SELECT * FROM `fees` where status='paid' and batch = 'plus 2'";//select query for viewing users.  
...
<?php  
include("connect.php");  
$view_users_query="SELECT * FROM `fees` where status='pending' and batch = 'plus 2'";//select query for viewing users.  
$run=mysqli_query($conn, $view_users_query);//here run the sql query.  
