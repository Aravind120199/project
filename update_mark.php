...
<td><a href="editmark.php?id=<?php echo $row[0]; ?>&b=<?php echo $user_batch;  ?>">Add Mark</a></td>
...
<!--here showing results in the table -->  
            ...
            <td><?php echo $user_Email_id;  ?></td> 
            <td><a href="addmark.php?id=<?php echo $row[0]; ?>&b=<?php echo $user_batch;  ?>">Add Mark</a></td>
