...
if (isset($_POST["submit"]))
{
    ...
    if($row = mysqli_fetch_array($data))
    {
     $lid = $row['ID'];
      ...
      mysqli_query($conn, "INSERT INTO `leave`(`sid`,`type`,`descr`,`fromdate`,`todate`)
     VALUES ('$lid','$type','$des','$fromdate','$todate')");
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <ul class="nav justify-content-end">
           ...
           <br>
           <br>
            <button style="color:white; background-color:gray; width:80px height:30px ;">Check my leave history</button></a>
            </ul>
