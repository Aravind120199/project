...
if (isset($_POST["submit"]))
{
   $name=$_POST['name'];
    ...
    if($row = mysqli_fetch_array($data))
    {
     ...
     $value='teacher';
      mysqli_query($conn, "INSERT INTO `leave`(`sid`,`name`,`type`,`descr`,`fromdate`,`todate`,`user`)
     VALUES ('$lid','$name','$type','$des','$fromdate','$todate','$value')");
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <ul class="nav justify-content-end">
           ...
           <br>
           <br>
           <button id="back" onclick="window.location.href='subject_tec_lev_history.php';">MY  Leave History</button>
            </ul>
